...
if __name__ == "__main__":
    ...
    try:
        ...
        tile_dir = "/srv/OpenTopoMap/tiles_wsgi"
    ...
    #render_tiles(bbox, mapfile, tile_dir, 11, 15, "World")
    ...
    #render_tiles(bbox, mapfile, tile_dir, 11, 15, "Canada + US")

    # BoundingBox BBO 2016-11-14 => Russie + Chine
    #bbox = (32.7,7.0,-169.5,77.9)
    #render_tiles(bbox, mapfile, tile_dir, 11, 15, "Russie + Chine")
    
    # BoundingBox BBO 2016-11-14 => Oceanie
    #bbox = (73.8,-44.8,154.0,11.2)
    #render_tiles(bbox, mapfile, tile_dir, 11, 14, "Oceanie")
    
    # BoundingBox BBO 2016-11-14 => South America 
    #bbox = (-94.0,-56.2,-33.7,13.1)
    #render_tiles(bbox, mapfile, tile_dir, 11, 15, "South America")
    #-------------------------------------------------------------------------
